...
export default {
  ...
  methods: {
    ...
    async loadCalendar(docName) {
      ...
      await this.$store.dispatch('fire/updateCropCalendar', this.calendar2JSON(this.currentCalendar))
    },
    ...
    onCalendarClick(data) {
      ...
      this.$store.dispatch('fire/updateCropCalendar', this.calendar2JSON(this.currentCalendar))
    ...
    fireSaveCalendar(){
      ...
      this.$store.dispatch('fire/fireSaveCropCalendar', this.calendar2JSON(this.currentCalendar))
    },
    onChangeSwitch(){
      this.currentCalendar.splice(0)
    },
    addNewCalendar(name){
      this.$store.dispatch('fire/updateCropCalendarId', name)
    },
    newCropCalendar() {
