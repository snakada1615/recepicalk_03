    ...
    <b-row class="my-2">
      <b-col cols="6">
        <b-card>
          <b-form-file
            v-model="myImageFile"
            :state="Boolean(myImageFile)"
            placeholder="replace picture..."
            drop-placeholder="Drop file here..."
            @change="getPic"
          ></b-form-file>
          <b-img thumbnail fluid-grow src="https://picsum.photos/250/250/?image=54" alt="Image 1"></b-img>
        </b-card>
      </b-col>
      <b-col cols="6">
...
export default {
  ...
  methods: {
    ...
    getPic (e) {
      this.myImageFile = e.target.files[0]
      console.log(this.myImageFile)
    },
    submitImg () {
      // ここでsubmitする
    },  }
